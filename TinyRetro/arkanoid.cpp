...
uint8_t Ball(uint8_t, uint8_t, GROUPE *);
uint8_t BallMissing(GROUPE *);
uint8_t Block(uint8_t, uint8_t, GROUPE *);
uint8_t CheckCollisionBall(GROUPE *);
uint8_t CheckCollisionWithBLOCK(GROUPE *);
uint8_t CheckCollisionWithTRACKBAR(GROUPE *);
uint8_t CheckLevelEnded(GROUPE *);
void LoadLevel(uint8_t, GROUPE *);
void PLAYMUSIC(void);
uint8_t PannelLevel(uint8_t, uint8_t, GROUPE *);
uint8_t PannelLive(uint8_t, uint8_t, GROUPE *);
void RecupeBALLPosForSIM(GROUPE *);
uint8_t RecupeDecalageY(uint8_t);
void RecupePositionOnGrid(GROUPE *);
uint8_t RecupeXPositionOnGrid(GROUPE *);
uint8_t RecupeYPositionOnGrid(GROUPE *);
void ResetBall(GROUPE *);
void ResetVar(GROUPE *);
void RsVarNewGame(GROUPE *);
void SimulMove(uint8_t, GROUPE *);
void Sound(uint8_t, uint8_t);
uint8_t SplitSpriteDecalageY(uint8_t, uint8_t, uint8_t);
void TestMoveBALL(GROUPE *);
void Tiny_Flip(uint8_t, GROUPE *);
uint8_t TrackBar(uint8_t, uint8_t, GROUPE *);
void UpdateBall(GROUPE *);
void WriteBallMove(GROUPE *);
