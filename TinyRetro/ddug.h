...
void Main_Sprite_TDDUG::GRID_UPDATE_RIGHT(void){
  ...
  uint8_t XX_=X()+7,YY_=Y();
 Ou_suis_je(XX_,YY_);
 if (READ_GRID_TDDUG(XX_,YY_)==1) {Snd_=1;SCORES_ADD_TDDUG();WRITE_GRID_TDDUG(XX_,YY_);}
 if (READ_GRID_TDDUG(XX_,YY_+1)==1) {Snd_=1;SCORES_ADD_TDDUG();WRITE_GRID_TDDUG(XX_,YY_+1);}
  if (Snd_) SND_DDUG();
  }
...
void Main_Sprite_TDDUG::GRID_UPDATE_UP(void){
 ...
 Ou_suis_je(XX_,YY_);
 if (READ_GRID_TDDUG(XX_,YY_)==1) {Snd_=1;SCORES_ADD_TDDUG();WRITE_GRID_TDDUG(XX_,YY_);}
 if (READ_GRID_TDDUG(XX_+1,YY_)==1) {Snd_=1;SCORES_ADD_TDDUG();WRITE_GRID_TDDUG(XX_+1,YY_);}
    if (Snd_) SND_DDUG();
  }
